...
public class GlobalParameters {
    ...
    /** the directory where to print the files. Default: the homedirectory */
    public File directory = new File(homeDirectory);
    ...
    public static String help() {
        return "Global Parameters:\n" +
                ...
                " - jobname    (default 'Test') Filename prefix for all generated files.\n"+
            ...
            switch(key) {
                ...
                case "directory" :
                    ...
                    if(!directory.isDirectory()) {
                        if(directory.exists()) {
                            errors.print(title,"Directory " + value + " is not a directory");}
