...
public class InfMergeResolutionTwoMore extends InferenceStep {
    ...
    public InfMergeResolutionTwoMore(Clause parentClause, String resolventBefore, Clause resolventAfter, Symboltable symboltable) {
