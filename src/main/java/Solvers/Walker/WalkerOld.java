 ...
 *   predicates whose flip causes most clauses to become true come to the front of the queue.
 *
 * Created by ohlbach on 16.05.2019.
 */
public abstract class WalkerOld extends Solver {
     ...
     */
    public WalkerOld(Integer solverNumber, HashMap<String,Object> solverParameters, ProblemSupervisor problemSupervisor) {
