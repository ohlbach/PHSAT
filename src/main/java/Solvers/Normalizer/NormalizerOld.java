 ...
 */
public class NormalizerOld extends Solver {
     ...
     */
    public NormalizerOld(ProblemSupervisor problemSupervisor) {
        super(1,null);
     ...
     */
    public NormalizerOld(int predicates, boolean monitoring) {
        super(1,null);
