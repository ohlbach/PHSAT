...
public class MRResolutionSquare1 extends InferenceStep{
    ...
    public MRResolutionSquare1(MRMatrix mrMatrix, CLiteral dLiteral, int colIndex, int[] colIndices, ArrayList<CLiteral[]> block) {
