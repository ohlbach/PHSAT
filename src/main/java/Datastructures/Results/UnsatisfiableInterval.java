...
/** This class documents a contradiction arsing from two clauses with the same predicates, but disjoint intervals
 */
public class UnsatisfiableInterval extends Unsatisfiable{
    private final Clause clause1;
    private final Clause clause2;

    /** constructs an Unsatisfiability from two clauses with the same predicates, but disjoint intervals
     *
    ...
    public String description(Symboltable symboltable) {
        ...
        return "Two clauses with the same predicates have disjoint intervals:\n" +
