 ...
 */
public class EquivalenceClassesOld {
     ...
     */
    public EquivalenceClassesOld(Symboltable symboltable,
     ...
     */
    public EquivalenceClassesOld(EquivalenceClassesOld eqClasses, BiConsumer<Integer,IntArrayList> contradictionHandler) {
    ...
    private void joinExistingClasses(IntArrayList literals, IntArrayList origins) {
        for(Object[] existingClass : existingClasses) {
            ...
            if(oldOrigins != null) {Utilities.joinIntArrays(origins,oldOrigins);}
