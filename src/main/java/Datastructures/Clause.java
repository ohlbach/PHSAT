...
public class Clause<Literal extends Datastructures.Literal> extends LinkedItem implements Cloneable {
     ...
     * Complementary literals are removed, except for AND and EQUIV clauses.<br>
     ...
     * Multiple occurrences and complementary literals are treated, but no other simplifications are done.
     *
