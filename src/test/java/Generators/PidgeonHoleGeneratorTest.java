...
public class PidgeonHoleGeneratorTest {
    ...
    public void parseProblemParameters() throws Exception {
        ...
        assertEquals("[{name=PH32, pidgeons=3, holes=2}, {name=PH42, pidgeons=4, holes=2}, {name=PH33, pidgeons=3, holes=3}, {name=PH43, pidgeons=4, holes=3}]",parameters.toString());
    }
    ...
    public void generate() throws Exception {
        ...
        assertEquals("Pidgeon Hole example with 5 pidgeons in 4 holes.\n" +
                "Disjunctions:\n" +
                "1 : P1H1 | P1H2 | P1H3 | P1H4\n" +
                "2 : P2H1 | P2H2 | P2H3 | P2H4\n" +
                "3 : P3H1 | P3H2 | P3H3 | P3H4\n" +
                "4 : P4H1 | P4H2 | P4H3 | P4H4\n" +
                "5 : P5H1 | P5H2 | P5H3 | P5H4\n" +
                "Disjoints:\n" +
                "6 : P1H1 /= P2H1 /= P3H1 /= P4H1 /= P5H1\n" +
                "7 : P1H2 /= P2H2 /= P3H2 /= P4H2 /= P5H2\n" +
                "8 : P1H3 /= P2H3 /= P3H3 /= P4H3 /= P5H3\n" +
                "9 : P1H4 /= P2H4 /= P3H4 /= P4H4 /= P5H4\n",bcl.toString());
