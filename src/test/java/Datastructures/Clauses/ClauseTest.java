...
public class ClauseTest {
    ...
    public void inference() {
        ...
        Clause clause = new Clause(100, ClauseType.OR);
    ...
    public void basicClauseOR() {
        ...
        assertSame(clause.clauseType, ClauseType.OR);
        assertEquals(0, clause.quantifier);
    ...
    public void basicClauseTypes() {
        ...
        assertSame(ClauseType.ATLEAST, clause.clauseType);
        ...
        clause = new Clause(basicClause);
        assertEquals(2, clause.quantifier);
        assertSame(ClauseType.ATMOST, clause.clauseType);
        ...
        clause = new Clause(basicClause);
        assertEquals(2, clause.quantifier);
        assertSame(ClauseType.EXACTLY, clause.clauseType);
    ...
    public void addCLiteral() {
        ...
        Clause cl = new Clause(1, ClauseType.OR);
    ...
    public void addLiterals() {
        ...
        lits.add(2);
        lits.add(3);
        Clause cl = new Clause(1, ClauseType.ATLEAST, 2, lits);
    ...
    public void addLiteralsAND() {
        ...
        lits.add(2);
        lits.add(3);
        Clause cl = new Clause(1, ClauseType.AND, lits);
    ...
    public void addCLiterals() {
        ...
        Clause cl = new Clause(1, ClauseType.ATMOST, 2, lits);
    ...
    public void addCLiteralsOR() {
        ...
        lits.add(new CLiteral(-2));
        lits.add(new CLiteral(3));
        Clause cl = new Clause(1, ClauseType.OR, lits);
    ...
    public void addCLiteralsList() {
        System.out.println("add CLiterals ...");
        Clause cl = new Clause(1, ClauseType.OR, -1, 2, -3);
        assertEquals("1: -1,2,-3", cl.toString());
        assertSame(ClauseStructure.MIXED, cl.structure);
        cl = new Clause(1, ClauseType.ATLEAST, 2, -1, 2, -3);
        assertEquals("L-1: ATLEAST 2: -1,2,-3", cl.toString());
        assertSame(ClauseStructure.MIXED, cl.structure);
    }
    ...
    public void cloneTest() {
        ...
        Clause cl1 = new Clause(1, ClauseType.OR, 1, 2, 3);
        ...
        Clause cl5 = new Clause(5, ClauseType.EXACTLY, 2, -1, -2, -3);
    ...
    public void contains() {
        ...
        Clause cl = new Clause(1, ClauseType.OR, 5, -6, 7);
    ...
    public void isSubset() {
        ...
        Clause cl1 = new Clause(1, ClauseType.OR, 5, -6, 7);
        Clause cl2 = new Clause(2, ClauseType.OR, 5, -6, 7);
        assertTrue(cl1.isSubset(cl2));

        Clause cl3 = new Clause(2, ClauseType.OR, 7, 5);
        assertTrue(cl3.isSubset(cl1));
        assertFalse(cl1.isSubset(cl3));
        Clause cl4 = new Clause(2, ClauseType.OR, 5, 6, 7);
        assertFalse(cl1.isSubset(cl4));

        Clause cl5 = new Clause(2, ClauseType.AND, 5, -6, 7);
    ...
    public void overlaps() {
        ...
        Clause cl1 = new Clause(1, ClauseType.OR, 1, 2, 3);
        Clause cl2 = new Clause(2, ClauseType.OR, 4, 5, 6);
        assertNull(cl1.overlaps(cl2));

        Clause cl3 = new Clause(3, ClauseType.OR, 3, 4, 5);
        assertEquals("[1, 3]", Arrays.toString(cl1.overlaps(cl3)));
        assertEquals("[1, 3]", Arrays.toString(cl3.overlaps(cl1)));

        Clause cl4 = new Clause(4, ClauseType.OR, -2, -3, 4);
    ...
    public void removeLiteral() {
        ...
        Clause c1 = new Clause(1, ClauseType.OR, 1, 2, 3);
        ...
        c1 = new Clause(2, ClauseType.OR, 1, 2, 3);
    ...
    public void doubles() {
        ...
        Clause c1 = new Clause(1, ClauseType.OR, 5, -6, -5, -6, -6);
    ...
    public void check() {
        ...
        Clause cl1 = new Clause(1, ClauseType.ATLEAST, 4, 1, 2, 3);
        assertFalse(cl1.check(errors));
        assertEquals("Clause 1: Quantifier 4 is not between 1 and 3\n",errors.toString());

        errors = new StringBuilder();
        cl1 = new Clause(1, ClauseType.ATLEAST, 2, 1, 2, 3);
