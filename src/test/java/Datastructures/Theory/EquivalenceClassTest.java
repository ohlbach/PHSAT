...
public class EquivalenceClassTest {
    ...
    public void equivalenceClass1() {
        ...
        literals.add(1);
        literals.add(3);
        EquivalenceClass eqClass = new EquivalenceClass(1,literals,orig);
        assertEquals("1: 1 = 2 = 3", eqClass.toNumbers());
        assertEquals("1: 1 = 2 = 3", eqClass.toString());
        assertEquals("1: 1 = 2 = 3 [10, 20]", eqClass.infoString(null));
        assertEquals("1: p = q = r", eqClass.toString("",symboltable));
        assertEquals("1: p = q = r [10, 20]", eqClass.infoString(symboltable));
    ...
    public void equivalenceClass2() {
        ...
        EquivalenceClass eqClass = new EquivalenceClass(1,literals,orig1);
        assertEquals("1: 1 = -2 = -3", eqClass.toNumbers());
        assertEquals("1: 1 = -2 = -3", eqClass.toString());
        assertEquals("1: 1 = -2 = -3 [10, 20]", eqClass.infoString(null));
        assertEquals("1: p = -q = -r", eqClass.toString("",symboltable));
    ...
    public void addEquivalenceClass2() {
        ...
        assertEquals("1: 1 = 3 = 4 = 2 = 5 = 6 [10, 20, 50, 30, 40]",
                eqClass1.infoString(null));}
