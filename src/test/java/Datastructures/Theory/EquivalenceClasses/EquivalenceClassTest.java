...
public class EquivalenceClassTest extends TestCase {
    ...
    public void testMakeEquivalenceClass() throws Unsatisfiable {
        ...
        EquivalenceClass eq1 = EquivalenceClass.makeEquivalenceClass(clause1,true);
        ...
        EquivalenceClass eq2 = EquivalenceClass.makeEquivalenceClass(clause2,true);
        assertEquals("1 = -2 = -3",eq2.toString());
        assertEquals(2,eq2.inferenceSteps.size());

        int[] clause3 = new int[]{12,eqv,2,-1,3,-2};
        try{
        EquivalenceClass eq3 = EquivalenceClass.makeEquivalenceClass(clause3,true);}
        ...
        EquivalenceClass eq4 = EquivalenceClass.makeEquivalenceClass(clause4,true);
        assertNull(eq4);
    }
    ...
    public void testJoinOverlappingClasses() throws Unsatisfiable {
        ...
        EquivalenceClass eq4 = EquivalenceClass.makeEquivalenceClass(clause3,true);
        EquivalenceClass eq5 = EquivalenceClass.makeEquivalenceClass(clause4,true);
        EquivalenceClass eq6 = eq4.joinOverlappingClasses(eq5,-1);
        assertEquals("1 = 3 = 5 = -2 = -4",eq6.toString());

        int[] clause5 = new int[]{14,eqv,2,3,-5};
        EquivalenceClass eq7 = EquivalenceClass.makeEquivalenceClass(clause5,true);
        try{
